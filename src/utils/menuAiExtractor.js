...
async function extractMenuFromFiles(files, businessId) {
  ...
  // Single-pass only (no per-photo refinement call) - the "Replace"/"Add
  // photo" button in the review screen is the actual reliability
  // mechanism for whatever this pass gets wrong, at zero extra API cost.
